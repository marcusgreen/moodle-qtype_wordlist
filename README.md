...
* Copy or rename the module directory to wordlist.
* Replace all occurances of wordlist in files with the new name for your question type.
* Rename files that have wordlist replacing wordlist with the new name for your question type.
